sap.ui.define(
	...
	function(UIComponent){
		return UIComponent.extend("gowri.app.Component",{
			metadata: {
				manifest: "json"
			},
			init: function(){
			...
			// 		viewName: "gowri.app.view.View1",
			// 		type: "XML"
			// 	});
			
			// 	var oView2 = new sap.ui.view("idView2",{
			// 		viewName: "gowri.app.view.View2",
			// 		type: "XML"
			// 	});
			// 	var oEmpty = new sap.ui.view("idEmpty",{
			// 		viewName: "gowri.app.view.Empty",
			// 		type: "XML"
			// 	});
